  ...
  const [auditLogs] = useState([
    {
      id: "1",
      time: "2:15 PM",
      action: "Cameron granted Viewer access to PorchCam (Shared)",
    },
    {
      id: "2",
      time: "1:30 PM",
      action: "Jason added to Neighborhood Watch group",
    },
    {
      id: "3",
      time: "12:45 PM",
      action: "Harsh shared Street Cam with All Members",
    },
    {
      id: "4",
      time: "11:20 AM",
      action: "Dev updated privacy settings for Street zone",
    },
  ]);
