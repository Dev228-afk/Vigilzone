...
from api.views import (
    ...
    notifications_broadcast, notifications_test_websocket, notifications_test_realtime, notifications_test_incident, notifications_transport_status,
    ai_webcam_state,
    debug_system,
...
urlpatterns += [
    ...
    path("api/notifications/test-realtime/", notifications_test_realtime, name="notifications-test-realtime"),
